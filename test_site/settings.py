...
SECRET_KEY = '$n317$7oar&39@=1f)usax)t!laklv23=c^((6457+02t*h&=$'
...
'''AUTH_PASSWORD_VALIDATORS = [
    {
        'NAME': 'django.contrib.auth.password_validation.UserAttributeSimilarityValidator', 'OPTIONS': {'max_similarity':1}
    },
    {
